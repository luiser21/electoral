	...
	$DBGestion->Consulta($sql);
	 ...
	 ?>
       	 <script language="javascript">
	       	 alert("Se ingreso el Lider exitosamente"); 
	       	 window.location="lideres.php";
       	 </script>
	   <?php	
...
<div class="main">
	<header>
	<form name="form2" method="post"  class="formular" action="lideres_add.php?add=1"  id="form2">
	<div style=" position:absolute; top:190px"><br/>
	<h4>Ingresar Lider</h4>
		...
		<div id="crudFormLineal" style="width: 910px; height: 510px; background-color:#FFFFFF; border-right:medium; border-right-color:#999999; border-right-width:medium" >
			...
			<div  style="width: 510px; height: 140px; background-color:#FFFFFF" >
			<ol>
				<li>
				 </li>
				 <li>
