...
header("Content-Disposition: attachment; filename=simpatizanntes_.xls");
...
<table width="605" border="0">
  <tr>
    <td width="447">Consolidado por Simpatizantes <br/>
    '.$_SESSION['nombre'].'<br/>
    Candidato al '.$_SESSION['tipocandidato'].'<br/>
    '.ucwords(strtolower($_SESSION['municipio'])).' - '. ucwords(strtolower($_SESSION['departamento'])).'<br/>
    '.$_SESSION['partido'].'<br/>
    Tarjeton # '.$_SESSION['ntarjeton'].'</td>
  </tr>
</table>
<p>&nbsp;</p>
