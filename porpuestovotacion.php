	...
	<div id="dashboard">
					...
					<div class="row-fluid">
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3" >
							<div class="dashboard-stat blue" style="padding-top: -64px;">
								<div class="visual"><img src="images/partners.png"  width="50" height="50" >
									<i class="icon-bar-chart"></i>
								</div>
								<div class="details">
									<div class="number">12.312</div>
									<div class="desc"></div>
								</div>
								<div class="more" >
								<strong style="font-size: 14px">PERSONAS HABILITADAS</strong><i class="m-icon-swapright m-icon-white"></i>
								</div>						
							</div>
						</div>
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
							<div class="dashboard-stat green">
								<div class="visual"><img src="images/voting-box-hi.png" width="50" height="50" />
									<i class="icon-shopping-cart"></i>
								</div>
								<div class="details">
									<div class="number"><?php echo @$datos[0]['VOTOSPREV']?></div>
									<div class="desc"></div>
								</div>
								<div class="more" >
								<strong style="font-size: 14px">POTENCIAL VOTANTES</strong><i class="m-icon-swapright m-icon-white"></i>
								</div>						
							</div>
						</div>
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
							<div class="dashboard-stat purple">
								<div class="visual"><img src="images/votaciones.png" width="50" height="50" />
									<i class="icon-bar-chart"></i>
								</div>
								<div class="details">
									<div class="number"><?php echo @$datos[0]['VOTOSPREV']?></div>
									<div class="desc">Simpatizantes</div>
								</div>
								<div class="more" >
								<strong style="font-size: 14px"><?php echo @$_SESSION['nombre']?></strong><i class="m-icon-swapright m-icon-white"></i>
								</div>							
							</div>
						</div>
						<div class="span3 responsive" data-tablet="span6" data-desktop="span3">
							<div class="dashboard-stat yellow">
								...
								<div class="more" >
								<strong style="font-size: 14px">CONCEJALES</strong><i class="m-icon-swapright m-icon-white"></i>
								</div>							
							</div>
						</div>
					</div>
