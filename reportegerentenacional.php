...
<iframe border=0 name=iframe src="mapas_U6.php" width="850" height="420" scrolling="no" noresize frameborder="0" onload="document.getElementById('loadImg').style.display='none';" align="center"></iframe>
<p></p>
	...
	<script type="text/javascript">
		...
		$(document).ready(function () {
			...
			$('#PeopleTableContainer').jtable({
				...
				actions: {
					listAction: 'PersonActionsPagedSorted_Informe_departamento_nacional.php?action=list'
